...
class urlListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by urlParser#url_.
    def enterUrl_(self, ctx:urlParser.Url_Context):
        pass

    # Exit a parse tree produced by urlParser#url_.
    def exitUrl_(self, ctx:urlParser.Url_Context):
        pass
